...
module.exports = {
  ...
  accept_dt_cash: (data) => {
    return new Promise(async (resolve, reject) => {
      ...
      var table_name = "td_transactions",
        ...
        values = `('${data.formNo}','${datetime}','${trn_id}','${data.subscriptionFee}','0','${data.admissionFee}','${data.donationFee}','0','${tot_amt}','${data.payment}','0','0000-00-00','0','${data.user}','${datetime}')`,
        where = null,
        flag = 0;
  ...
  accept_dt_cheque: (data) => {
    return new Promise(async (resolve, reject) => {
      ...
      var table_name = "td_transactions",
        fields = `(form_no,trn_dt,trn_id,sub_amt,onetime_amt,adm_fee,donation,premium_amt,tot_amt,pay_mode,chq_no,chq_dt,chq_bank,created_by,created_at)`,
        values = `('${data.formNo}','${datetime}','${trn_id}','${data.subscriptionFee}','0','${data.admissionFee}','${data.donationFee}','0','${tot_amt}','${data.payment}','${data.cheque_no}','${data.cheque_dt}','${data.bank_name}','${data.user}','${datetime}')`,
        where = null,
        flag = 0;
      var res_dt = await db_Insert(table_name, fields, values, where, flag);
