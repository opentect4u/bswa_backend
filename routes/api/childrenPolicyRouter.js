...
const { children_form_save } = require("../../modules/children_policyModule");
...
//    console.log(data,'data_cp');
   ...
   var select = "member_id,mem_type,memb_name,unit_id,gurdian_name,gender,marital_status,DATE_FORMAT(dob, '%Y-%m-%d') dob,IFNULL(TIMESTAMPDIFF(YEAR, dob, CURDATE()), 0) AS age,memb_address,phone_no",
